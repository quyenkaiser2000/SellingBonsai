        ...
        <div class="page-wrapper">
            ...
            <div class="card">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#messages" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Đang duyệt</span></a> </li>
                </ul>
                <!-- Tab panes -->
