                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($orderdetails as $orderdetail)
                                                                <tr>
                                                                    ...
                                                                    <td>{{$orderdetail->order->payment_method}}</td>
                                                                    @if($orderdetail->order->discount_code_id != null)
                                                                        <td>{{number_format((($orderdetail->total) - (($orderdetail->total * $orderdetail->order->discountcode->discount)/100)))}} VNĐ</td>
                                                                    @else
                                                                    ...
                                                                    @endif
                                                                    <td>
                                                                            <button type="submit" class="btn btn-success"> <a href="order/{{ $orderdetail->id }}" style="color:white;">Detail</a></button>
