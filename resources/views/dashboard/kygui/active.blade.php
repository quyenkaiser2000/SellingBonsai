        ...
        <div class="page-wrapper">
            ...
            <div class="card">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"> <a class="nav-link "  href="{{'/admin/dashboard/kygui'}}" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Tất cả</span></a> </li>
                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#profile" role="tab"><span class="hidden-sm-up"></span> <span class="hidden-xs-down">Đang hoạt động</span></a> </li>
